...
MNIST -> (Encode) -> MNIST -> (Decode) -> MNIST
"""
...
encoder_generator.save('model/one_layer_mnist_mnist_encoder_generator.h5')
decoder_generator.save('model/one_layer_mnist_mnist_decoder_generator.h5')