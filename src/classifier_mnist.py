...
print('************************')
print('Classifier MNIST')
print('************************')

# Load data
model_name = 'classifier_mnist'
...
diagram_displayer.display_samples(name='Classifier MNIST Accuracy',
                                  samples=accuracy,
                                  should_display_directly=should_display_directly,
                                  should_save_to_file=should_save_to_file)
diagram_displayer.display_samples(name='Classifier MNIST Validation Accuracy',
