...
print('************************')
print('Classifier Face')
print('************************')

# Load data
face_images = []
face_labels = []
model_name = 'classifier_face'
...
diagram_displayer.display_samples(name='Classifier Face Accuracy',
                                  samples=accuracy,
                                  should_display_directly=should_display_directly,
                                  should_save_to_file=should_save_to_file)
diagram_displayer.display_samples(name='Classifier Face Validation Accuracy',
