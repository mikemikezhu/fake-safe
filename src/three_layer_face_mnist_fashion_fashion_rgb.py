...
outer_encoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_outer_encoder_generator.h5')
mid_encoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_mid_encoder_generator.h5')
inner_encoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_inner_encoder_generator.h5')

outer_decoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_outer_decoder_generator.h5')
mid_decoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_mid_decoder_generator.h5')
inner_decoder_generator.save(
    'model/three_layer_face_mnist_fashion_fashion_rgb_inner_decoder_generator.h5')
