...
Face -> (Encode) -> MNIST -> (Encode) -> Fashion -> (Encode) -> Fashion ->
(Decode) -> Fashion -> (Decode) -> MNIST -> (Decode) -> Face 
"""
...
outer_encoder_generator_creator = ImageGeneratorModelCreator(constants.RGB_INPUT_SHAPE,
...
for current_round in range(constants.TOTAL_TRAINING_ROUND):
    ...
    mnist_indexes = np.random.randint(0,
                                      ...
                                      constants.DISPLAY_ROW * constants.DISPLAY_COLUMN)
    mnist_images = mnist_image_test_scaled[original_indexes]
    ...
    image_displayer_gray.display_samples(name=mid_encoded_name,
    ...
    g_loss_mid, g_acc_mid = mid_encoder_gan.evaluate(mnist_images,
                                                     y_ones)
    ...
    image_displayer_gray.display_samples(name=mid_decoded_name,
                                         samples=mid_decoded_images,
                                         should_display_directly=should_display_directly,
                                         should_save_to_file=should_save_to_file)
    # Evaluate
    loss_mid, accuracy_mid = mid_decoder_gan.evaluate(mnist_images,
                                                      mnist_images)
...
outer_encoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_outer_encoder_generator.h5')
mid_encoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_mid_encoder_generator.h5')
inner_encoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_inner_encoder_generator.h5')

outer_decoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_outer_decoder_generator.h5')
mid_decoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_mid_decoder_generator.h5')
inner_decoder_generator.save('model/three_layer_face_mnist_fashion_fashion_rgb_inner_decoder_generator.h5')