...
outer_encoder_generator.save(
    'model/two_layer_mnist_mnist_fashion_outer_encoder_generator.h5')
inner_encoder_generator.save(
    'model/two_layer_mnist_mnist_fashion_inner_encoder_generator.h5')

outer_decoder_generator.save(
    'model/two_layer_mnist_mnist_fashion_outer_decoder_generator.h5')
inner_decoder_generator.save(
    'model/two_layer_mnist_mnist_fashion_inner_decoder_generator.h5')
